...
public class MetionsReadLocalTask extends AsyncTask<com.cattong.entity.Status, Void, Void> {
	...
	public MetionsReadLocalTask(MentionsListAdapter adapter, MetionsCache cache, LocalStatus divider) {
	    this.cache = cache;
